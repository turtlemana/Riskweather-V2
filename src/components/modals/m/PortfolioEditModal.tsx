...
function PortfolioEditModal({
  ...
  return (
    <main className="z-40 fixed   bg-white left-0 top-0 w-full h-screen overflow-y-auto">
      {!isLoading ? (
        <div className="flex flex-col  space-y-3">
          ...
          <div className="px-5 flex items-center justify-between">
            <div className=" flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-1.5 bg-gray-50 p-1 text-gray-500 rounded-xl">
                <Image
                  width={17}
                  height={14}
          ...
          {isPortfolioNameEditModalOpen && (
            <div className="z-50 fixed top-0 left-0 w-full h-screen flex items-center justify-center bg-black bg-opacity-30 overflow-y-auto">
              <div
                ...
                className="z-20 absolute text-start text-[#111111] bg-white py-6 px-5 rounded-20 top-1/2 left-1/2 translate-x-half translate-y-half border  w-5/6"
              >
                ...
                <button
                  ...
                  className={`p-3 mt-3 text-white rounded-xl text-center w-full ${
