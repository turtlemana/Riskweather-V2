...
function HighCVarModal({
  ...
  return (
    <main className="z-30 fixed pb-[125px] slim-scroll  bg-white top-16 w-full  max-w-[800px] h-screen overflow-y-auto">
      <div className="flex flex-col  space-y-8">
        ...
        <div className="flex flex-col ">
          ...
          <div className="text-sm w-screen max-w-[800px]  py-2 px-10 text-gray-500 bg-gray-100 flex justify-between items-center">
            <p>종목명</p>
