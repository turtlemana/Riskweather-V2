...
function ProfileModal({ setIsProfileModalOpen, userProfile, mutate }: props) {
  ...
  return (
    <main className=" z-30 fixed pb-[150px] slim-scroll  bg-white top-20 w-full min-w-[360px]  max-w-[800px] h-screen overflow-y-auto">
      <div className="flex flex-col  space-y-10">
        ...
        <section className={""}>
          ...
          <div className="px-5 space-y-2">
            <p className="ml-10 text-sm  text-gray-500 font-medium">이름</p>

            <article className="mb-4 px-10">
              <input
                type="text"
        ...
        <div className="flex justify-center fixed bottom-20 w-full min-w-[360px] max-w-[800px]">
          <button
            className="bg-[#0198FF] mt-5 p-2 rounded-xl text-white font-bold  w-[360px] max-w-[600px] w-800:w-full mb-6 hover:bg-[#0085E6] disabled:bg-[#D1D5DB]"
            onClick={saveClick}
          >
            {"완료"}
          </button>
