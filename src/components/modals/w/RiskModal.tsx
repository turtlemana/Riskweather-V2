...
function RiskModal({
  ...
  const riskModalContent = (
    <main className="z-50 flex justify-center fixed   pb-[150px] bg-gray-50 top-16  w-screen   h-screen overflow-y-auto slim-scroll">
                ...
                {data.length > 0 && !isValid ? (
                  <div>
                    ...
                    {slice < 100 && slice % 10 === 0 && (
                      <div className="cursor-pointer px-2 py-1 border border-t-gray-100 shadow-sm  w-full mb-[70px]">
                        <div
                          onClick={() => {
  ...
  return ReactDOM.createPortal(riskModalContent, document.body);
}
