...
import { OptionModal } from "components/modals/w/OptionModal";
...
function InterestTable({
  ...
  return (
    <div className="flex flex-col h-screen overflow-y-auto slim-scroll ">
      <div className="flex-grow overflow-auto slim-scroll pb-14">
        <div className="p-5">
      ...
      <div className="fixed  bottom-20 left-0 right-0 flex justify-center">
        <button
          ...
          className="w-full max-w-[600px] mx-8 text-blue-500 font-bold bg-blue-50 rounded-lg py-2 px-4"
        >
          +자산 추가
        </button>
      </div>
