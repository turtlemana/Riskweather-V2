...
import HighCVarModal from "components/modals/w/HighCVaRModal";
...
function RiskTable({ data, type, setType, isValid }: Props) {
  ...
  return (
    <div className="flex flex-col ">
      <div className="flex space-x-3 px-20  font-semibold justify-between ">
      ...
      <div>
        <div className="text-sm w-full py-2 px-7 text-gray-500 bg-gray-100 flex justify-between items-center">
          <p>종목명</p>
        ...
        <ul className=" flex flex-col border border-b-gray-100">
          {data.length > 0 && !isValid ? (
            <div>
              ...
              <div className="cursor-pointer px-2 py-1 border border-t-gray-100 shadow-sm  w-full ">
                <div
