...
import RiskModal from "../../../modals/w/RiskModal";
...
const TopBar = () => {
  ...
  return (
    <header className="fixed top-0 w-full z-30 bg-white h-16 border-b border-gray-100 py-[14px] px-5  max-w-full ">
      <Head>
      ...
      {isRiskModalOpen && (
        <div className="flex w-full items w-800:justify-center">
          <RiskModal setIsRiskModalOpen={setIsRiskModalOpen} />
        </div>
      )}
    </header>
  );
