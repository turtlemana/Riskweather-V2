...
const MenuBar = () => {
  ...
  return (
    <header className="min-w-[360px] border border-t-gray-200 fixed  bottom-0 w-full z-40 bg-white h-16 py-[20px]  border-b border-gray-100  px-5 ">
      <Head>
      ...
      <div className="px-16 max-w-[1920px] pb-5 pt-2 h-full mx-auto flex items-center justify-between w-full">
        <Link
          href="/"
