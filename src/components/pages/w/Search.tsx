...
import SearchModal from "components/modals/w/SearchModal";
import SearchTable from "components/organisms/w/SearchTable";
...
function Search({}: {}) {
  ...
  return (
    <main className="pt-5 pb-[150px] bg-white slim-scroll z-30   top-16 w-screen max-w-[800px] min-w-[360px] h-screen overflow-y-auto">
      <div className="flex flex-col space-y-5 ">
        <div className="px-8 ">
          <section
            ...
            className="cursor-pointer  h-10 mt-5   py-5 px-4 flex items-center border border-solid border-gray-100 bg-gray-50 rounded-xl "
          >
            <Image
