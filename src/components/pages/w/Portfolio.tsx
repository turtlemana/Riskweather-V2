...
import NoPortfolio from "components/templates/w/portfolio/NoPortfolio";
import PortfolioAddModal from "components/modals/w/PortfolioAddModal";
import PortfolioEditModal from "components/modals/w/PortfolioEditModal";
import Main from "components/templates/w/portfolio/Main";
import PortfolioDetail from "components/templates/w/portfolio/PortfolioDetail";
import AddAssets from "components/templates/w/portfolio/AddAssets";
import {
...
function Portfolio({ session }: any) {
  ...
  return (
    <main className="w-screen min-w-[360px] max-w-[800px] h-auto">
      {!session ||
