...
import Modal from "components/templates/w/login/SignUpModal";
...
const Login = ({ providers }: Props) => {
  ...
  return (
    <main className="min-h-screen min-w-[1024px] pt-[152px] pb-[144px] bg-white text-center shadow-[0_0_12px_0_rgba(121,120,132,0.15)]">
      ...
      <div className={"flex justify-center items-center mb-5"}>
        <div className="flex flex-col gap-5">
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center gap-4">
              <input
                ...
                className="p-2 border rounded-md flex-grow disabled:bg-gray-300"
                required
              ...
              {!state.isVerified && (
                <button
                  ...
                  className="disabled:bg-gray-500 bg-blue-500 text-white px-3 py-1.5 rounded-md "
                >
                  {state.isAuthStarted
          ...
          <label className="flex items-center gap-2 mt-4">
            ...
            <span className="text-sm text-start ml-0.5">
              {router.locale === "ko"
                ? "서비스 이용약관 및 개인정보처리방침을 확인하였고, 이에 동의합니다"
          ...
          <label className="flex items-center gap-2 mt-2">
            ...
            />
            <span className="text-sm">{t("alarm")}</span>
          </label>
