...
import InterestTable from "components/organisms/w/InterestTable";
import { OptionModal } from "components/modals/m/OptionModal";
import InterestSearchModal from "components/modals/w/InterestSearchModal";
...
function Interest() {
  ...
  return (
    <main className="min-w-[360px] max-w-[800px] h-auto bg-white">
      <InterestTable
        update={update}
