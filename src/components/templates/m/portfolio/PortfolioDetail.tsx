...
import PortfolioBarChart from "chart/PortfolioBarChart";
import { COLORS } from "data/default";
import PortfolioAssetTable from "components/organisms/m/PortfolioAssetTable";
            ...
            <div className="pt-5">
              ...
              <div className="pt-5 ">
                ...
                state.portfolio.portfolioLevel === "Very High volatility" ? (
                  <div className="truncate px-2 py-3 border rounded-xl flex items-center justify-between">
                    {state.portfolio?.portfolioLevel ? (
                      <div
