...
import TypeModal from "components/modals/w/TypeModal";
    ...
    <main className="mb-3 w-full   bg-white">
      <div className="flex flex-col p-5 ">
        ...
        <section
          ...
          className="w-full cursor-pointer h-10 mt-3 mb-5 py-2.5 px-4 flex items-center border border-solid border-gray-100 bg-gray-100 rounded-xl "
        >
          <Image
