...
import ProfileModal from "components/modals/w/ProfileModal";
import ToleranceModal from "components/modals/w/ToleranceModal";
import AskModal from "components/modals/w/AskModal";
function Menu({ userProfile, mutate }: any) {
  ...
  return (
    <main className="w-full bg-white px-5 pt-2 pb-16">
