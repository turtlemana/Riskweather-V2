...
function Header({
  ...
  return (
    <main className="w-[800px] mb-3   bg-white ">
      <div className="flex flex-col ">
        <div className="fixed z-30  pt-20 min-w-[360px] max-w-[800px] w-full  h-[100px]  bg-white opacity-100 px-5 py-5 flex justify-between items-center">
          <Image
        ...
        <div className="pt-[120px] flex shrink-0 space-x-3 items-center  pb-2 px-5">
          <Image
            unoptimized
            quality={100}
        ...
        <div className="flex space-x-5 px-5 pt-6  font-semibold">
          <div className="flex flex-col">
            ...
            >
              <div
                className={
                  "flex space-x-1 items-center flex-shrink-0 cursor-pointer"
                }
              >
                <p>{"AI 분석"}</p>
                <Image
        ...
        <hr />
        {type === "AI" && (
          <div className="w-800:flex w-800:items-center w-800:space-x-20 ">
